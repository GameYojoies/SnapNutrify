            ...
            v && (t.controller.control = p.controller.control),
              w &&
                (!t.isElement ||
                  ...
                  o.classList.add("swiper-pagination").css('position','absolute','left','50%','transform','translateX(-50%)'),
